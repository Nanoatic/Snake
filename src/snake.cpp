...
snake::snake(int width, int height, string snakename, color rgb) : window(FAT * width, FAT * height, snakename, rgb),
                                                                   direction(0), feeding(0), deployed(false), score(0),
                                                                   loss(false) {
    head = new part{1, 1, IDLE, nullptr, nullptr};
    tail = head;
    reset2D = SDL_CreateRGBSurface(0, FAT, FAT, 32, 0, 0, 0, 0);
...
snake::snake(int width, int height, string snakename) : window(FAT * width, FAT * height, snakename), direction(0),
